...
public class ColorsDropdownTest extends BaseTest{
	ColorsDropdownPage clr;
	...
	public void initWebsite(@Optional("chrome") String browser) throws InterruptedException {
		...
		clr = new ColorsDropdownPage(driver); // Initialize Page Object
	}
			@Test(priority = 1)//,groups= {"sanity"})

	public void VerifyCountryDropdown() throws InterruptedException {
		//clr.scrollToElementColors();
		clr.selectColorByVisibleText("White");
	}
}
